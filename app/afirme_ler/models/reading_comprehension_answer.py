...
class ReadingComprehensionAnswer(db.Model):
    __tablename__ = "reading_comprehension_answer"
    __table_args__ = {"schema": "tenant"}

    id = db.Column(db.String, primary_key=True, default=lambda: str(uuid.uuid4()))
    session_id = db.Column(
        db.String,
        db.ForeignKey("tenant.reading_evaluation_session.id", ondelete="CASCADE"),
        nullable=False,
    )
    ...
    session = db.relationship("ReadingEvaluationSession", back_populates="answers")
