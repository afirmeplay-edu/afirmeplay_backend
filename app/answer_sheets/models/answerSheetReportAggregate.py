# -*- coding: utf-8 -*-
"""Cache de relatórios agregados para cartão-resposta (por gabarito), em schema city_xxx."""
...
class AnswerSheetReportAggregate(db.Model):
    __tablename__ = "answer_sheet_report_aggregates"
