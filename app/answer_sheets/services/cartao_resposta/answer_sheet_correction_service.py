...
class AnswerSheetCorrectionService:
    ...
    def corrigir_cartao_resposta(self, image_data: bytes) -> Dict[str, Any]:
        ...
        try:
            ...
            from app.answer_sheets.services.cartao_resposta.course_name_resolver import resolve_grade_name_for_proficiency
    ...
    def _calcular_proficiencia_classificacao(self, score_percentage: float, 
        ...
        try:
            from app.evaluations.services.evaluation_calculator import EvaluationCalculator, CourseLevel, Subject
