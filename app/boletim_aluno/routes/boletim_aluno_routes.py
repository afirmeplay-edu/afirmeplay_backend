...
from app.boletim_aluno.services.filters import build_boletim_filter_options
from app.boletim_aluno.services.helpers import parse_aluno_param, parse_pagination
from app.boletim_aluno.services import build_boletins_digital
from app.participation_report.services.filters import is_answer_sheet_report, parse_id_list
...
def resumo_boletim():
    ...
    try:
        ...
        if is_answer_sheet_report(request.args):
            from app.boletim_aluno.services.answer_sheet import build_boletins_answer_sheet
