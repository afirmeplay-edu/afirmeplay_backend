...
from app.evaluations.services.evaluation_filters import EvaluationFilters
from app.evaluations.services.evaluation_aggregator import EvaluationAggregator
...
def rebuild_report_cache(test_id: str):
    ...
    try:
        ...
        from app.reports.routes.report_routes import _montar_resposta_relatorio, _montar_resposta_relatorio_por_turmas
        from app.services.ai_analysis_service import AIAnalysisService
...
def mapa_habilidades_avaliacao_online():
    ...
    Não chama IA; use /mapa-habilidades/analise-ia.
...
def relatorio_consolidado_opcoes_filtros():
    ...
    """
    try:
        from app.reports.services.consolidated_report_service import get_digital_filter_options
