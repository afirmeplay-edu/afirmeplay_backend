...
questão, usando a rubrica SIM / PARCIAL / NAO / BRANCO (ver app.exams.models.subjectiveResult).
...
from app.exams.models.subjectiveTest import SubjectiveTest
...
from app.exams.models.subjectiveResult import SubjectiveResult, RUBRIC_VALUES, RUBRIC_WEIGHTS
from app.exams.models.subjectivePresence import SubjectivePresence
from app.evaluations.services.evaluation_calculator import EvaluationCalculator
from app.evaluations.services.evaluation_result_snapshot import build_placement_snapshots_from_student
...
class SubjectiveEvaluationService:
    ...
    def _mark_reports_dirty(shadow_test_id: str, evaluation_result: EvaluationResult, student_obj) -> None:
        try:
            ...
            if scope_city_id:
                try:
                    from app.reports.report_analysis.tasks import rebuild_reports_for_test
