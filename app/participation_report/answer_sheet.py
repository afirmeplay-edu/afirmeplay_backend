...
from app.participation_report.filters import obter_estados, obter_municipios, parse_id_list
...
def build_participation_report_answer_sheet(
    ...
    from app.routes.answer_sheet_routes import _load_cartao_roster_and_results
