...
from app.reports.excel_export.data_transformer import DataTransformer
from app.reports.excel_export.formatters import ExcelFormatter
from app.reports.excel_export.matplotlib_chart_builder import MatplotlibChartBuilder
...
class ExcelEvolutionExporter:
    ...
    def _create_cover_sheet(self, municipality: str, state: str, department: str,
        ...
        try:
            import os
            logo_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'assets', 'afirme_logo.png')
