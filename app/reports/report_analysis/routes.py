...
from app.reports.routes.report_routes import _determinar_escopo_por_role
import logging
...
from app.reports.report_analysis.tasks import trigger_rebuild_if_needed
from app.reports.report_analysis.tasks import trigger_rebuild_answer_sheet_if_needed
from app.reports.report_analysis.tasks import rebuild_answer_sheet_report_for_scope
from app.reports.report_analysis.tasks import _get_schema_for_scope
...
def force_rebuild(evaluation_id: str):
    ...
    try:
        ...
        if use_sync:
            # Processar síncrono
            from app.reports.report_analysis.tasks import rebuild_report_for_scope
