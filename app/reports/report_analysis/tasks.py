...
from app.reports.report_analysis.services import ReportAggregateService
from app.reports.report_analysis.calculations import (
...
def rebuild_report_for_scope(
    ...
    try:
        ...
        if use_cached_payload:
            ...
            if scope_type == 'teacher':
                from app.reports.routes.report_routes import _montar_resposta_relatorio_por_turmas
...
def rebuild_reports_for_test(
    ...
    try:
        ...
        from app.reports.models.reportAggregate import ReportAggregate
...
def trigger_rebuild_if_needed(
    ...
    from app.reports.report_analysis.debounce import ReportDebounceService
...
def rebuild_answer_sheet_report_for_scope(
    ...
    from app.reports.report_analysis.answer_sheet_report_builder import build_answer_sheet_report_payload
    from app.services.ai_analysis_service import AIAnalysisService
    ...
    try:
        ...
        if use_cached:
            ...
            try:
                ...
                from app.reports.report_analysis.answer_sheet_report_builder import empty_answer_sheet_payload
...
def rebuild_answer_sheet_reports_for_gabarito(
    ...
    from app.answer_sheets.models.answerSheetReportAggregate import AnswerSheetReportAggregate
